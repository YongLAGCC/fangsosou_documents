...
<div align="left">
  ...
  [![GitHub Pull Requests](https://img.shields.io/github/issues-pr/kylelobo/The-Documentation-Compendium.svg)](https://github.com/YongLAGCC/fangsosou_documents/pulls)
...
[![Circle CI](https://circleci.com/gh/tmcw/docbox.svg?style=shield)](https://github.com/YongLAGCC/fangsosou_documents)
...
All custom code - code that relates to brands and specifics of APIs - is in the `./src/custom` directory. Content is [src/custom/content.js](https://github.com/YongLAGCC/fangsosou_documents/issues) and brand names & tweaks are in [src/custom/index.js](src/custom/index.js), with inline documentation for both.
...
* Mapillary uses docbox for [API Documentation](https://www.mapillary.com/developer/api-documentation/) and [Tiles Documentation](https://github.com/YongLAGCC/fangsosou_documents)
